...
def register(app: flask.Flask, *args, **kwargs):
    ...
    def view_create():
        if flask.request.method == 'GET':
            return tools.render('error.html', title='Unsupported request method!', description=f'This website can\'t be viewed with GET, as it\'s supposed to be POSTed.')
    ...
    def view_page(code):
        ...
        if not view:
            return tools.render('error.html', title='View page not found!', description=f'Couldn\'t find this code: {code}')
